...
<head>
    ...
    <title><?php echo $translate[$_SESSION["lang"]]["6x6"]; ?></title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                   <?php echo $translate[$_SESSION["lang"]]["6x6"]; ?>
                </h1>
            </div>
			<div class="col-md-6">
			<div class="panel">
                <img class="img-responsive" src = "Captions/dve_vozidla.png" alt="">
				</div>
            </div>
			<div class="col-md-6">
			<div class="panel">
                <h2> <?php echo $translate[$_SESSION["lang"]]["techdata"]; ?></h2>
<p></p><ul class="star-list"><li><?php echo $translate[$_SESSION["lang"]]["cartweight"]; ?></li>
<li><?php echo $translate[$_SESSION["lang"]]["cartdimen"]; ?></li>
<li><?php echo $translate[$_SESSION["lang"]]["control"]; ?></li>
<li><?php echo $translate[$_SESSION["lang"]]["drive"]; ?></li>

<li><?php echo $translate[$_SESSION["lang"]]["power"]; ?></li>
<li><?php echo $translate[$_SESSION["lang"]]["supply"]; ?></li>
<li><?php echo $translate[$_SESSION["lang"]]["source"]; ?></li>
<li><?php echo $translate[$_SESSION["lang"]]["capacity"]; ?></li>
				</div>
            </div>
            <div class="col-md-12">
                <div class="panel">
                    <img class="img-responsive" src = "Captions/Render_ISO.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- /.row -->
