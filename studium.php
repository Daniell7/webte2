...
<head>
    ...
    <title><?php echo $translate[$_SESSION["lang"]]["study"];?></title>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                ...
                <?php echo $translate[$_SESSION["lang"]]["study"];?>
            </h1>
        </div>
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-heading shadow">
                    <a href="studium/uchadza.php"><h4>Pre uchádzačov o štúdium</h4></a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-heading shadow">
                    <a href="studium/bcstud.php"><h4>Bakalárske štúdium</h4></a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-heading shadow">
                    <a href="studium/ingstud.php"><h4>Inžinierske štúdium</h4></a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-heading shadow">
                    <a href="studium/docstud.php"><h4>Doktorandské štúdium</h4></a>
                </div>
            </div>
        </div>
    </div>
