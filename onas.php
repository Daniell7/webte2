...
<head>
    ...
    <title><?php echo $translate[$_SESSION["lang"]]["about"]; ?></title>
...
<body>
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><?php echo $translate[$_SESSION["lang"]]["about"]; ?></h2>
            </div>
            <div class="col-md-12">
                
                <p><?php echo $translate[$_SESSION["lang"]]["abouttext"]; ?></p>
            </div>
        </div>
        <!-- /.row -->
